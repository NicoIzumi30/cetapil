...
@section('dashboard-content')
    <x-card>
        ...
        <x-slot:cardAction>
            <x-button.info>Tambah Jenis Visual</x-button.info>
            <x-button.info>Tambah Jenis POSM</x-button.info>
				...
				<div class="relative w-full mx-3 border-red">
					<div class="flex justify-center items-center flex-col py-2 h-[260px]">
						...
						<div id="preview-container-banner" class="w-full relative">
							<img id="preview-image-banner" src="{{ asset('assets/images/banner-placeholder.png') }}" alt="Preview" 
