            ...
            $(document).ready(function () {
                ...
                window.getPowerSkuData = function (powerSkuId) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            const surveyType = response.category === 'Power SKU' ?
                                'power-sku' : 'harga-kompetitor';
                            ...
                            $('#edit-power-sku-container').addClass('hidden').removeClass(
                                'grid');
                            ...
                            if (response.category === 'Power SKU') {
                                ...
                                if (response.product) {
                                    ...
                                    $('#edit-power-sku').data('stored-value', response
                                        .product.id);
                                }
                            } else {
                                // Show competitor container
                                $('#edit-product-competitor-container').removeClass(
                                    'hidden');
                ...
                $('#edit-select-input-survey-data').on('change', function () {
                    ...
                    if (selectedValue === 'power-sku') {
                        ...
                        $('#edit-product-competitor-container').removeClass('hidden').addClass(
                            'block');
                    }
                });
                    ...
                    if (categoryId) {
                        ...
                        $.ajax({
                            ...
                            success: function (products) {
                                ...
                                const selectedValue = $('#edit-power-sku').data(
                                    'selected-value');
                                if (selectedValue) {
                                    $('#edit-power-sku').val(selectedValue).trigger(
                                        'change');
                                }
                            },
                            error: function () {
                ...
                $('#edit-power-sku-product-categories').change(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (products) {
                            ...
                            const storedProductId = $('#edit-power-sku').data(
                                'stored-value');
                            if (storedProductId) {
                                $('#edit-power-sku').val(storedProductId).trigger(
                                    'change');
                            }
                        },
                        error: function () {
