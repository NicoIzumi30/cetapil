...
<x-card>
    ...
    {{-- Selling Action --}}
    <x-slot:cardAction>
        <x-input.search wire:model.live="search" class="border-0" id="global-search"
            placeholder="Cari data penjualan"></x-input.search>
        ...
        $(document).ready(function () {
            let table = $('#selling-table').DataTable({
                ...
                dataSrc: function (json) {
                    ...
                    { data: 'total', name: 'total', className: 'table-data', render: data => 'Rp ' + data },
                    {
                        data: 'actions',
                        name: 'actions',
                        orderable: false,
