@props(['title', 'name', 'id', 'placeholder'])

<div class="mb-4">
    <label for="{{ $id }}" class="form-label !text-black">{{ $title }}</label>
    <div class="flex items-center gap-4">
        <input 
            ...
            {{ $attributes }} 
        />
        <button type="button" class="toggle-password mr-3">
            <i class="eye-open hidden">
