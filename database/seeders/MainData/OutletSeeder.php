        ...
        try {
            ...
            foreach(range(1, 2000) as $index) {
                $outlets[] = [
                    ...
                    'name' => $faker->company,
                    'tipe_outlet' => $faker->randomElement(['MT', 'GT']),
                    'account' => $faker->company,
                    'category' => $faker->randomElement(['A', 'B', 'C']),
                    'distributor' => $faker->company,
                    'TSO' => $faker->name,
                    'KAM' => $faker->name,
                    'visit_day' => $faker->randomElement(['1', '2', '3', '4', '5', '6', '7']),
                    'longitude' => $faker->longitude(95, 141),
                    'latitude' => $faker->latitude(-11, 6),
                    'address' => $faker->address,
                    'status' => 'APPROVED',
                    'cycle' => $faker->randomElement(['1x1', '1x2', '1x4']),
                    'week' => $faker->randomElement(['1', '2', '3', '4', '1&3', '2&4']),
