...
class SellingCard extends StatelessWidget {
  ...
  const SellingCard({
    Key? key,
    required this.outlet, required this.status, required this.ontap,
  }) : super(key: key);
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Text("Senin, 01/11/2024",style: TextStyle(fontSize: 11,fontStyle: FontStyle.italic),)
              ],
            ),
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  child: Text(
                    status,
                    style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold, color: status == "Drafted" ? Colors.blue : Colors.white),
                  ),
                ),
                ElevatedButton(
                  onPressed: ontap,
