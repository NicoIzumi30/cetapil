...
class DetailVisibilityPrimary extends GetView<TambahVisibilityController> {
                          ...
                          child: ListView(
                            children: [
                              ...
                              ModernTextField(
                                enable: false,
                                title: "Lebar Rak (cm)",
                                controller: TextEditingController(text: data['shelf_width']),
                              ),
                              ModernTextField(
                                enable: false,
                                title: "Shelving",
                                controller: TextEditingController(text: data['shelving']),
                              ),
