        ...
        Row(
          ...
          Expanded(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    "Stock On Hand",style: TextStyle(fontWeight: FontWeight.bold),
                  ),
                  SizedBox(height: 10,),
                  Text(
                    productName,
          ...
          Expanded(
            child: Column(
              children: [
                Text("Stock",style: TextStyle(fontSize: 10,fontWeight: FontWeight.bold),),
                NumberField(
          ...
          Expanded(
            child: Column(
              children: [
                Text("AV3M(Pcs)",style: TextStyle(fontSize: 10,fontWeight: FontWeight.bold),),
                NumberField(
          ...
          Expanded(
            child: Column(
              children: [
                Text("Recommend",style: TextStyle(fontSize: 10,fontWeight: FontWeight.bold),),
                NumberField(
