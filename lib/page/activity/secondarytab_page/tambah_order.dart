...
class _CompactProductCardState extends State<CompactProductCard> {
  ...
  void initializeControllers() {
    ...
    hargaController = TextEditingController(text: existingValues['harga']);
          ...
          Padding(
            ...
            child: Row(
              children: [
                Expanded(
                    flex: 2,
                    child: _buildInputField('Jumlah', jumlahController)),
                SizedBox(width: 8),
                Expanded(
                    flex: 5,
                    child: _buildInputField('Harga', hargaController)),
                // SizedBox(width: 8),
