        ...
        builder: (context, constraints) {
          ...
          return Row(
            ...
            children: [
              ...
              _buildNavItem(1, 'Routing', Color(0xFF39B5FF), "assets/icon/Vector1.svg", itemWidth),
              _buildNavItem(2, 'Outlet', Color(0xFF39B5FF), "assets/icon/Vector2.svg", itemWidth),
              _buildNavItem(3, 'Activity', Color(0xFF39B5FF), "assets/icon/Vector3.svg", itemWidth),
              _buildNavItem(4, 'Selling', Color(0xFF39B5FF), "assets/icon/Vector4.svg", itemWidth),
            ],
          );
        }
      ),
  ...
  Widget _buildNavItem(int index, String label, Color color, String pathIcon, double itemWidth) {
    return Obx(() {
      return TweenAnimationBuilder<double>(
        tween: Tween<double>(
          begin: 0,
          end: controller.selectedIndex.value == index ? -8 : 0
        ),
